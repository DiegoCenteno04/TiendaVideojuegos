...
namespace TiendaVideojuegos.View
{
    public partial class Ventas : Form
    {
        ...
        private void ObtenerRegistro()
        {
            ...
            adapt = new SqlDataAdapter("select*from Ventas", conex);
            adapt.Fill(dt);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(fecha) || string.IsNullOrWhiteSpace(total) || string.IsNullOrWhiteSpace(descuento))
            {
            ...
            try
            {
                ...
                VentaControllers controller = new VentaControllers(connectionString);

                // 5. Llamar al método del controlador para agregar el videojuego
                bool agregadoExitosamente = controller.AgregarNuevoVenta(nuevoVenta);
